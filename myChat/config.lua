...
ns.Config = {
	...
	editbox = {
		...
		docking = {
			...
			offset		= 0,		--Positive values move it up, Negative values move it down.  Defaults to 0
		},
		textures = {
			...
			alpha		= 0.7,       	--False uses default alpha
		},
		font = { 					--False/invalid values inherit ChatFontNormal values
	...
	timestamps = {
		...
		custom			= '%H.%M.%S', 	--Allows a custom timestamp format.  Setting the timestamps in interface options will override this.
	...
	formats = {
		...
		brackets = {
			...
			channel 	= true,		--Enable/disable channel brackets
			url 		= true,		--Enable/disable url brackets
		},
	},			
	stickyChannels = {
		['say'] 				= true,
